...
import CustomDateTime from "../../../components/Date";
                    ...
                    <article>
                        <header>
                            ...
                            <div className="articles-date mb-5">
                                <span> <CustomDateTime id={article.id}/> • <ReadDuration/></span>
                            </div>
                        </header>
                        ...
                        <footer className="d-flex justify-content-start">
                            <a target="_blank" href="https://twitter.com">Discuss on Twitter</a>
                            <a target="_blank" href="https://github.com" className="ms-2">Edit on GitHub</a>
                        </footer>
                    </article>
                </main>
